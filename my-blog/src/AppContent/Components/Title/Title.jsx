...
export default function Title(){
    ...
    useEffect(() => {
        ...
        then(result=>{
            ...
            setPoetryData({content:'加载错误,请重试',origin:{dynasty:'',author:''}})
    ...
    <div className={style.titleContent}>
        ...
        isLoading?
        <h1>正在加载...</h1> :
        <div><h1><em>{poetryData.content}</em></h1>
        <p><strong>{`${poetryData.origin.dynasty}`}  {`${poetryData.origin.author}`}</strong></p>
        </div>
        }
